...
def append_v3_routers(mapper, routers):
    ...
    sid_controller = controllers.SidV3()
    routers.append(
    ...
    mapper.connect('/sidinfos/{sid_id}',
                   controller=sid_controller,
                   action='get_sidinfo',
                   conditions=dict(method=['GET']))
    mapper.connect('/sids/{sid_id}',
                   controller=sid_controller,
                   action='delete_sid',
    ...
    mapper.connect('/sids/{domain_id}/users/{user_id}/roles/{role_id}',
                   controller=role_controller,
                   action='create_sid_grant',
                   conditions=dict(method=['PUT']))
    mapper.connect('/sips/{project_id}/users/{user_id}/roles/{role_id}',
                   controller=role_controller,
                   action='create_sid_grant',
                   conditions=dict(method=['PUT']))
