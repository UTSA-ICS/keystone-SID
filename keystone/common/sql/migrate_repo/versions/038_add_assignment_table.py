...
def upgrade(migrate_engine):
    ...
    assignment_table = sql.Table(
        ...
        sql.Column('type', sql.Enum(
            ...
            assignment_sql.AssignmentType.USER_SIP,
            assignment_sql.AssignmentType.GROUP_SIP,
            assignment_sql.AssignmentType.USER_SID,
            assignment_sql.AssignmentType.GROUP_SID,
            name='type'),
            nullable=False),
